  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,0.9fr)_minmax(380px,0.7fr)]">
          <section className="rounded-[26px] border border-stone-900/8 bg-white p-5 shadow-[0_8px_24px_rgba(28,24,20,0.04)] sm:p-6">
          ...
          <section className="rounded-[26px] border border-stone-900/8 bg-white p-5 shadow-[0_8px_24px_rgba(28,24,20,0.04)] sm:p-6">
            ...
            {isDetailLoading ? (
              ...
              <div className="mt-5">
                <div className="mx-auto max-w-[440px] rounded-[28px] border border-dashed border-stone-300 bg-stone-50 p-5 text-stone-900">
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            ...
                            <p className="mt-2 text-base font-semibold text-stone-950">
                              Identifier {transaction.identifier_number}
                            </p>
