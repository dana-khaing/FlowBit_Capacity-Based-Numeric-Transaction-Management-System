...
from .views import (
    ...
    ChangePasswordView,
    ForgotPasswordView,
    ForgotOverrideCodeView,
    VerifyEmailView,
    ResendVerificationView,
    ResetPasswordConfirmView,
    ResetOverrideCodeConfirmView,
...
urlpatterns = [
    ...
    path('auth/forgot-override-code/', ForgotOverrideCodeView.as_view(), name='auth-forgot-override-code'),
    ...
    path('auth/reset-override-code/', ResetOverrideCodeConfirmView.as_view(), name='auth-reset-override-code'),
