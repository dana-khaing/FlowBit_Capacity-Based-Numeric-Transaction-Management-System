...
FRONTEND_OVERRIDE_RESET_URL = config('FRONTEND_OVERRIDE_RESET_URL', default='')
OVERRIDE_RESET_TOKEN_EXPIRY_HOURS = config('OVERRIDE_RESET_TOKEN_EXPIRY_HOURS', cast=int, default=2)
